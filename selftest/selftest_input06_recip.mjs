...
const BASE = [
  ...
  // ★ task-80：负负得正等价已归并 ⇒ [1,3,4,6] 4→3、[3,3,8,8] 7→6、[2,4,5,8] 3→2
  //   消失的三条已实证为保留条的「分子分母同时取反」书写，数值均 24/1。
  [[1, 2, 3, 4], 3, 4], [[2, 3, 4, 6], 10, 10], [[1, 3, 4, 6], 1, 3],
  [[3, 3, 8, 8], 1, 6], [[1, 2, 5, 10], 2, 1], [[1, 1, 3, 8], 1, 0],
  [[1, 4, 6, 8], 3, 1], [[2, 4, 5, 8], 7, 2], [[1, 5, 5, 5], 1, 1],
];
