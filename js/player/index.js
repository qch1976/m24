...
const BULLET_SPEED_MIN = 6;
const BULLET_SPEED_MAX = 14;
...
export default class Player extends Animation {
  ...
  shoot() {
    ...
    const speed = Math.floor(Math.random() * (BULLET_SPEED_MAX - BULLET_SPEED_MIN + 1)) + BULLET_SPEED_MIN;
    bullet.init(this.x + this.width / 2 - bullet.width / 2, this.y - 10, speed);
